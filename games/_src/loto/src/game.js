...
var SFX = false;//$.jStorage.get("opt_sfx");
var MUSIC = false;//$.jStorage.get("opt_music");
...
if (CREDITS === null || CREDITS < BETS[0]) {
...
BasicGame.GameLoad.prototype = {
    ...
    preload: function () {
        this.game.load.image('preloader_logo', 'assets/preloader_logo.png');
    },
    create: function () {
        var p = 0;
    ...
    BeginLoad: function () {
        this.load.atlasJSONHash('basis', 'assets/basis_high.png', 'assets/basis_high.json');
        this.load.atlasJSONHash('symbols', 'assets/symbols.png', 'assets/symbols.json');
        //   this.load.audio('sfx_win_jackpot', ['assets/audio/win_jackpot.mp3', 'assets/audio/win_jackpot.ogg']);
        //   this.load.audio('sfx_win_normal', ['assets/audio/win_normal.mp3', 'assets/audio/win_normal.ogg']);
        //   this.load.audio('sfx_Startbutton', ['assets/audio/startButton.mp3', 'assets/audio/startButton.ogg']);
        //   this.load.audio('sfx_wheel_start', ['assets/audio/wheel_start.mp3', 'assets/audio/wheel_start.ogg']);
        //   this.load.audio('sfx_wheel_stop', ['assets/audio/wheel_stop.mp3', 'assets/audio/wheel_stop.ogg']);
        //   this.load.audio('music_bg', ['assets/audio/bg.mp3', 'assets/audio/bg.ogg']);
        this.load.start();
    },
    CallGame: function () {
...
BasicGame.Game.prototype = {
    create: function () {
        ...
        for (i = 0; i < WLDATA.length; i++) {
            if (h_begin_now == h2_begin) {
                h_begin_now = h1_begin;
                h_end_now = h1_end;
            } else {
                h_begin_now = h2_begin;
                h_end_now = h2_end;
            }
        ...
        for (var pos = 1; pos < WLDATA.length + 1; pos++) {
            ...
            var label_l = this.game.add.text(startxpos + wl.width / 2, startypos + wl.height / 2 + 5, WLDATA[pos - 1].line + 1, {
                font: "bold 30px Arial",
                fill: "#ffffff"
            });
            label_l.anchor.set(0.5);
            var label_r = this.game.add.text(startxpos2 + wl.width / 2, startypos + wl.height / 2 + 5, WLDATA[pos - 1].line + 1, {
                font: "bold 30px Arial",
                fill: "#ffffff"
            });
        ...
        this.ValueJackpot = this.game.add.text(90, 1010, this.number_format(JACKPOT, DECIMAL, ',', ''), {
            font: "bold 18px Arial",
            fill: "#ffffff"
        });
        this.ValueCredits = this.game.add.text(250, 1010, this.number_format(CREDITS, DECIMAL, ',', ''), {
            font: "bold 18px Arial",
            fill: "#ffffff"
        });
        this.ValueBet = this.game.add.text(425, 1010, this.number_format(BETS[BET_POS], DECIMAL, ',', ''), {
            font: "bold 18px Arial",
            fill: "#ffffff"
        });
        this.ValueMessage = this.game.add.text(1185, 1010, LANG[LANGUAGE]['welcome'], {
            font: "bold 18px Arial",
            fill: "#ffffff"
        });
        ...
        this.jpframe_title = this.game.add.text(this.jpframe.width / 2, 30, LANG[LANGUAGE]['msg_win_jp'], {
            font: "bold 38px Arial",
            fill: "#ffffff"
        });
        this.jpframe_title.anchor.x = 0.5;
        this.jpwin_field = this.game.add.text(this.jpframe.width / 2, this.jpframe.height - 70, 0, {
            font: "bold 38px Arial",
            fill: "#ffffff"
        });
        ...
        this.helpmenu_title1 = this.game.add.text(this.helpbg.x + this.helpbg.width / 2, this.helpbg.y + 30, LANG[LANGUAGE]['helpmenu_title'], {
            font: "bold 38px Arial",
            fill: "#ffffff"
        });
        ...
        this.settings_title1 = this.game.add.text(this.settingsbg_width / 2, 30, '', {
            font: "bold 38px Arial",
            fill: "#ffffff"
        });
        this.settings_title1.anchor.x = 0.5;
        this.settings_title2 = this.game.add.text(this.settingsbg_width / 2, 240, '', {
            font: "bold 38px Arial",
            fill: "#ffffff"
        });
        this.settings_title2.anchor.x = 0.5;
        this.settings_opt_label1 = this.game.add.text(100, 110, '', {
            font: "bold 20px Arial",
            fill: "#ffffff"
        });
        this.settings_opt_label2 = this.game.add.text(100, 150, '', {
            font: "bold 20px Arial",
            fill: "#ffffff"
        });
        ...
        this.settings_opt_label3 = this.game.add.text(100, 190, '', {
            font: "bold 20px Arial",
            fill: "#ffffff"
        });
        ...
        this.settings_lang1_button.events.onInputDown.add(function () {
            this.PressLang('en');
        }, this);
        this.settings_lang2_button.events.onInputDown.add(function () {
            this.PressLang('de');
        }, this);
        this.settings_lang3_button.events.onInputDown.add(function () {
            this.PressLang('es');
        }, this);
    ...
    CreateFaktorLabels: function (xpos, ypos, i) {
        if (i < 10) {
            var t1 = this.game.add.text(xpos + 150, ypos + 10, '3 = ' + LANG[LANGUAGE]['bet'] + ' x' + SYM_FAKTORS[i - 1]['match_3'], {
                font: "bold 20px Arial",
                fill: "#ffffff"
            });
            var t2 = this.game.add.text(xpos + 150, t1.y + 39, '4 = ' + LANG[LANGUAGE]['bet'] + ' x' + SYM_FAKTORS[i - 1]['match_4'], {
                font: "bold 20px Arial",
                fill: "#ffffff"
            });
            var t3 = this.game.add.text(xpos + 150, t2.y + 39, '5 = ' + LANG[LANGUAGE]['bet'] + ' x' + SYM_FAKTORS[i - 1]['match_5'], {
                font: "bold 20px Arial",
                fill: "#ffffff"
            });
            ...
            var t2 = this.game.add.text(xpos + 150, ypos + 49, '5 = ' + LANG[LANGUAGE]['desc_jp_sym'], {
                font: "bold 20px Arial",
                fill: "#ffffff"
            });
            this.faktorlables.add(t2);
    ...
    PressInfo: function () {
        if (!this.play && !this.settings && !this.settings_delay && !this.help && !this.help_delay) {
            ...
            this.info_ani = this.add.tween(this.helpmenu).to({
                x: 0
        ...
        if (this.help == true && !this.help_delay) {
            this.help_delay = true;
            this.info_ani2 = this.add.tween(this.helpmenu).to({
                x: this.game.width
            }, 300, Phaser.Easing.Linear.None, true, 500);
    ...
    PressSettings: function () {
        if (!this.play && !this.settings && !this.settings_delay && !this.help && !this.help_delay) {
            ...
            this.settings_ani = this.add.tween(this.settingsmenu).to({
                x: 0
            }, 300, Phaser.Easing.Linear.None, true, 500);
        ...
        if (this.settings == true && !this.settings_delay) {
            this.settings_delay = true;
            this.settings_ani2 = this.add.tween(this.settingsmenu).to({
                x: -this.settingsbg_width - 50
            }, 300, Phaser.Easing.Linear.None, true, 500);
    ...
    PlayWalze1: function () {
        ...
        this.walze1_ani = this.add.tween(this.walze1).to({
            y: this.walze1.y + (250 * 6)
        }, speed, art, true);
        if (SFX === true) {
            this.walze1_ani.onStart.add(function () {
                this.WheelStartSFX.play();
            }, this);
        }
    ...
    PlayWalze2: function () {
        ...
        this.walze2_ani = this.add.tween(this.walze2).to({
            y: this.walze2.y + (250 * 6)
        }, speed, art, true, delay);
        if (SFX === true) {
            this.walze2_ani.onStart.add(function () {
                this.WheelStartSFX.play();
            }, this);
        }
    ...
    PlayWalze3: function () {
        ...
        this.walze3_ani = this.add.tween(this.walze3).to({
            y: this.walze3.y + (250 * 6)
        }, speed, art, true, delay);
        if (SFX === true) {
            this.walze3_ani.onStart.add(function () {
                this.WheelStartSFX.play();
            }, this);
        }
    ...
    PlayWalze4: function () {
        ...
        this.walze4_ani = this.add.tween(this.walze4).to({
            y: this.walze4.y + (250 * 6)
        }, speed, art, true, delay);
        if (SFX === true) {
            this.walze4_ani.onStart.add(function () {
                this.WheelStartSFX.play();
            }, this);
        }
    ...
    PlayWalze5: function () {
        ...
        this.walze5_ani = this.add.tween(this.walze5).to({
            y: this.walze5.y + (250 * 6)
        }, speed, art, true, delay);
        if (SFX === true) {
            this.walze5_ani.onStart.add(function () {
                this.WheelStartSFX.play();
            }, this);
        }
    ...
    CheckWinlines: function (CheckLine) {
        ...
        var match = 0;
        var isJP = false;
        if (this.walze1.children[this.Reverse(WLDATA[CheckLine].vpos1 - 0.5)].frameName == this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName && this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName == this.walze3.children[this.Reverse(WLDATA[CheckLine].vpos3 - 0.5)].frameName && this.walze3.children[this.Reverse(WLDATA[CheckLine].vpos3 - 0.5)].frameName == this.walze4.children[this.Reverse(WLDATA[CheckLine].vpos4 - 0.5)].frameName && this.walze4.children[this.Reverse(WLDATA[CheckLine].vpos4 - 0.5)].frameName == this.walze5.children[this.Reverse(WLDATA[CheckLine].vpos5 - 0.5)].frameName) {
            match = 5;
        } else if (this.walze1.children[this.Reverse(WLDATA[CheckLine].vpos1 - 0.5)].frameName == this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName && this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName == this.walze3.children[this.Reverse(WLDATA[CheckLine].vpos3 - 0.5)].frameName && this.walze3.children[this.Reverse(WLDATA[CheckLine].vpos3 - 0.5)].frameName == this.walze4.children[this.Reverse(WLDATA[CheckLine].vpos4 - 0.5)].frameName && this.walze1.children[this.Reverse(WLDATA[CheckLine].vpos1 - 0.5)].frameName != 'sym_10.png') {
            match = 4;
        } else if (this.walze1.children[this.Reverse(WLDATA[CheckLine].vpos1 - 0.5)].frameName == this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName && this.walze2.children[this.Reverse(WLDATA[CheckLine].vpos2 - 0.5)].frameName == this.walze3.children[this.Reverse(WLDATA[CheckLine].vpos3 - 0.5)].frameName && this.walze1.children[this.Reverse(WLDATA[CheckLine].vpos1 - 0.5)].frameName != 'sym_10.png') {
            match = 3;
        }
        if (match > 0) {
