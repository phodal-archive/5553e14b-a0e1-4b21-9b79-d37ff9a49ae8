...
Cifras.Result.prototype.init = function() {
	...
	console.log('end: result init');
};

Cifras.Result.prototype.setResult = function(value) {
	console.log('start: result setResult');
	this.value = value;
	...
	console.log('end: result setResult');
}

Cifras.Result.prototype.goOut = function(wins,callFunc) {
	console.log('start: result goOut');
	var tmax = 400;
	...
	console.log('end: result goOut');
}

Cifras.Result.prototype.goIn = function(match,callFunc) {
	console.log('start: result goIn');
